  		...
  		<form class="form-horizontal" method="POST" action="php_action/createOrder.php" id="createOrderForm">
			  ...
			  <div class="col-md-6">
				  ...
				  <div class="form-group" style="display: none;">
						...
						<div class="col-sm-9">
							<input type="text" class="form-control" id="discount" name="discount" value="0" readonly="true" autocomplete="off" />
						</div>
					</div><!--/form-group-->	
				  <div class="form-group" style="display: none;">
			  ...
			  <div class="col-md-6">
			  	<div class="form-group" style="display: none;">
				    ...
				    <div class="col-sm-9">
				      <input type="text" class="form-control" id="paid" name="paid" value="0" readonly="true" autocomplete="off" />
				    </div>
				  </div> <!--/form-group-->			  
				  <div class="form-group" style="display: none;">
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-9">
				      <select class="form-control" name="paymentStatus" id="paymentStatus">
				      	<option value="">~~SELECT~~</option>
				      	<option value="1">Successfully Ordered</option>
